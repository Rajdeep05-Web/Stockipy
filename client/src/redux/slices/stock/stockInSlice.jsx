...
const API_URL = 'http://192.168.29.163:5000/api/v1/stock-ins' || 'http://localhost:5000/api/v1/stock-ins'  ;
...
export const addStockIn = createAsyncThunk('stockIn/addStockIn', async (stockInDataAll, {rejectWithValue}) => {
    ...
    try {
        const fileUploadResponse = file ? await axios.post( API_URL_FILE_UPLOAD, formData,
            {
