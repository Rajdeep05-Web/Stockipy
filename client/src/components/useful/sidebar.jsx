...
const Sidebar = ({ setSidebarOpen, sidebarOpen }) => {
  ...
  return (
    <div
      id="sidebar"
      className={`fixed z-50 inset-y-0 left-0 w-[200px] bg-white bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-80 backdrop-blur-md border border-neutral-200 rounded-r-xl lg:rounded-none dark:border-gray-700 transform transition-transform duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
